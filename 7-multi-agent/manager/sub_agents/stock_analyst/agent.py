...
stock_analyst = Agent(
    ...
    instruction="""
    You are an helpful stock market assistant that helps users track their stocks of intrest.
    ...
    - GOOG: $175.34 (updated at 2025-10-01 16:30:00)
    - TSLA: $156.78 (updated at 2025-10-01 16:30:00)
    - META: $123.45 (updated at 2025-10-01 16:30:00)"

    If the user asks about anything else,
    you should delegate the task to the manager
    """,
