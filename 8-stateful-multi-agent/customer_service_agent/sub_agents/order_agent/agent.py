...
def refund_course(tool_context:ToolContext)->dict:
    """
    Simulate refunding the AI Marketing Platform course.
    Updates state by removing the course from purchased course.
    """
    ...
    #Update purchases courses in state via assigment
    ...
    new_interaction_history.append(
        {"action":"refund course","course_id":course_id,"timestamp":current_time}
    ...
    return {
        ...
        your $149 will be refunded to your original payment method within 3-5 business days.""",
        "course_id":course_id,
